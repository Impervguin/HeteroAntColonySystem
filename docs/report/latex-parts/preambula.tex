...
\newcommand{\ssrnotoc}[1]{\begin{center}
		\LARGE\bfseries{#1}
\end{center}}

\newcommand{\smalsrnotoc}[1]{\begin{center}
		\Large\bfseries{#1}
\end{center}}
...
\newtotcounter{totalbib}
\let\oldbibitem\bibitem
\renewcommand{\bibitem}[2][]{%
	\stepcounter{totalbib}%
...
\newcounter{myListingCounter}
\renewcommand{\themyListingCounter}{\thechapter.\arabic{myListingCounter}}